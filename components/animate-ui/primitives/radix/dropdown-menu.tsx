...
function DropdownMenuSubTrigger({
  ...
  const highlightedRefSlot = React.useRef<React.RefObject<HTMLDivElement | null> | null>(
    null,
  );
  const [, highlightedRef] = useDataState<HTMLDivElement>(
    ...
    (value) => {
      if (value === true) {
        const el = highlightedRefSlot.current?.current;
  ...
  React.useLayoutEffect(() => {
    highlightedRefSlot.current = highlightedRef;
  });
